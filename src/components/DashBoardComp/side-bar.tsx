...
export function Sidebar({
    ...
    return (
        <aside className="h-full flex flex-col bg-gray-600">
    
            <div className='shrink-0 flex justify-between p-3 items-center bg-gray-200'>
            ...
            <ul className="flex-1 overflow-y-auto bg-gray-600 no-scroll">
                {users.map((user) => {
