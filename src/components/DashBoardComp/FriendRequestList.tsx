                ...
                >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 sm:gap-6 w-full">
                        ...
                        <div className="flex items-center gap-3 sm:gap-4 lg:gap-6 w-full lg:w-auto">
                            <div
                                className={`w-12 h-12 sm:w-14 sm:h-14 lg:w-16 lg:h-16 rounded-full ${getAvatarColor(req.senderGender)} flex items-center justify-center text-white font-bold text-lg sm:text-xl lg:text-2xl shadow-md shrink-0`}
                            >
                                {getInitials(req.senderId.firstName, req.senderId.lastName)}
                            </div>
